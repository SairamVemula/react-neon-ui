    ...
    render() {
        ...
        return (
            <div className={styles.main} style={{ color: this.sltColor.primary, border: `solid 2px ${this.sltColor.primary} `, background: background || '#031321' }} onClick={this.onClick}>
                ...
                <svg className={styles.svg} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width={"20"} height={"20"} viewBox="0 0 292.362 292.362" style={{ fill: this.sltColor.primary }}>
                    <g>
